...
function ToDoRow({ isChecked, descr }) {
    const checkBox = isChecked ? <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const descrClass = isChecked ? "todo-row__descr todo-row__descr_checked" : "todo-row__descr";
